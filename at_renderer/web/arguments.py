...
def get_args() -> dict:
    ...
    parser.add_argument('-sh', '--server-host', dest="server_host", help="Server host", required=False, default="127.0.0.1")
    parser.add_argument('-sp', '--server-port', dest="server_port", help="Server port", type=int, required=False, default=8000)
